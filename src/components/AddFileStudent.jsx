        ...
        <div className="mb-6 w-full flex justify-center">
            ...
            {selectedFile && (
                <div className="w-full fixed inset-0 flex items-center justify-center z-50 bg-gray-800 bg-opacity-75">
                    <div className="w-[50%] max-w-[900px] bg-white rounded-lg p-3 space-y-4 mx-1">
                        ...
                        <div className="w-full h-auto max-h-96">
                            <a href={selectedFile} download className="block text-center text-white bg-blue-500 hover:bg-blue-700 rounded p-2">
                                Download
                            </a>
                        </div>
                    </div>
